  ...
  admin: [
...

    {
      ...
      children: [
        ...
        { name: "Ruangan", path: "/admin/master-data/ruangan" },
    ...
    },
    {
      ...
      children: [
        { name: "Surat Peringatan (SP)", path: "/admin/manajemen-siswa/surat-peringatan" },
    ...
    { name: "Tiket Bantuan", icon: LifeBuoy, path: "/admin/tiket" },
